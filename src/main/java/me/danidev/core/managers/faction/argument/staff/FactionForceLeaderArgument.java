...
public class FactionForceLeaderArgument extends CommandArgument {
    ...
    public FactionForceLeaderArgument(final Main plugin) {
        super("forceleader", "Force leader of a faction.");
        this.plugin = plugin;
	...
	public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        sender.sendMessage(String.valueOf(ChatColor.GOLD.toString()) + ChatColor.BOLD + "Leader of " + playerFaction.getName() + "was forcefully set from " + oldLeaderName + " to " + newLeaderName + '.');
        return true;
    }
