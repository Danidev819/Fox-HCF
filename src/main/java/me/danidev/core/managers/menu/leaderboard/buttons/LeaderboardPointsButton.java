...
public class LeaderboardPointsButton extends Button {

    private final Comparator<PlayerFaction> POINTS_COMPARATOR = Comparator.comparingInt(PlayerFaction::getPoints);
    ...
    public ItemStack getButtonItem(Player player) {
        ...
        List<PlayerFaction> data = Main.get().getFactionManager().getFactions().stream()
                ...
                .filter(x -> x.getPoints() > 0).distinct()
