...
import me.danidev.core.managers.timer.event.TimerExtendEvent;
import me.danidev.core.managers.timer.event.TimerPauseEvent;
...
public abstract class PlayerTimer extends Timer {
	...
	public void setPaused(Player player, UUID playerUUID, boolean paused) {
