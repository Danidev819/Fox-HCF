package me.danidev.core.license;
...
public class License {
    ...
    public boolean verify() {
        CC.log("");
        CC.log("&d=====&5============&8[&bLicense&8-&bSystem&8]&d============&5=====");
        ...
        if (respo[0].equals("2") && Boolean.parseBoolean(respo[3])) {
            ...
            CC.log("");
            CC.log("&d=====&5========================================&d=====");
            CC.log("            &6&lfHCF &8- [&a0.0.1&8]");
            CC.log("");
            CC.log(" &8|- &6Author&8: &bDanidev819");
            CC.log(" &8|- &6Version&8: &b" +  plugin.getDescription().getVersion());
            CC.log(" &8|- &6Discord&8: &bhttps://dsc.gg/hardling");
            ...
            CC.log("&d=====&5========================================&d=====");
            CC.log("");
            CC.log(" &eYour license is valid, but version is outdated.");
            CC.log("");
            CC.log(" &8|- &6Your version&8: &7" + plugin.getDescription().getVersion());
            CC.log(" &8|- &7Latest version&8: &7" + respo[1].split("#")[1]);
            CC.log("");
            CC.log("&d=====&5========================================&d=====");
            return Boolean.parseBoolean(respo[3]);
        } else {
