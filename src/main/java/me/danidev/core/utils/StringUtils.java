...
public class StringUtils
{
    ...
    public static String formatInt(final int i) {
        ...
        return String.valueOf(String.valueOf((h > 0) ? new StringBuilder(String.valueOf(h)).append(":").toString() : "")) + ((min < 10) ? ("0" + min) : min) + ":" + ((sec < 10) ? ("0" + sec) : sec);
    }
    ...
    public static String getEntityName(final Entity entity) {
        final String name;
        final String s;
        switch (s = (name = entity.getType().name())) {
            case "VILLAGER": {
                return "Villager";
            }
            case "PLAYER": {
    ...
    public static Object getTime(final int seconds) {
        ...
        if (minutes < 60) {
            if (secondsLeft > 0) {
                return String.valueOf(String.valueOf(String.valueOf(minutes)) + "m " + secondsLeft + "s");
            }
            return String.valueOf(String.valueOf(String.valueOf(minutes)) + "m");
        }
        else {
            if (minutes < 1440) {
                String time = "";
                final int hours = minutes / 60;
                time = String.valueOf(String.valueOf(hours)) + "h";
                ...
                if (secondsLeft > 0) {
                    time = String.valueOf(String.valueOf(time)) + " " + secondsLeft + "s";
                }
                return time;
            }
            String time = "";
