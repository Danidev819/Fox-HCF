...
public class PlayerList implements Iterable<Player> {
    ...
    public Iterator<Player> iterator() {
        return new Iterator<Player>() {
            ...
            public boolean hasNext() {
                return !PlayerList.this.playerUniqueIds.isEmpty()
                        && this.index < PlayerList.this.playerUniqueIds.size();
            }
    ...
    public boolean add(Player player) {
        if (this.playerUniqueIds.contains(player.getUniqueId())) return false;
        this.playerUniqueIds.add(player.getUniqueId());
        return true;
    }
